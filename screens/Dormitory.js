                ...
                <ScrollView
                    ...
                    <View style={styles.tableContent}>
                        ...
                        <View style={{ alignContent: 'center', marginTop:-20, height: 100 + '%', alignItems: 'center', justifyContent: 'center' }}>
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>NOVA</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>POP ART</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>PRİME</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>NOVAL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>GOLDEN PLUS</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>PERA</Text></View >
