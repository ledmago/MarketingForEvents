                ...
                <ScrollView
                    ...
                    <View style={styles.tableContent}>
                        ...
                        <View style={{ alignContent: 'center', marginTop:-20, height: 100 + '%', alignItems: 'center', justifyContent: 'center' }}>
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>CAGE</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>CRATOS</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>ALMAHARA</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>ODYSSEY</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>SKY LOUNGE & BAR</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>SOHO</Text></View >
