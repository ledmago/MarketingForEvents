                ...
                <ScrollView
                    ...
                    <View style={styles.tableContent}>
                        ...
                        <View style={{ alignContent: 'center', marginTop:-20, height: 100 + '%', alignItems: 'center', justifyContent: 'center' }}>
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>SALAMİS</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>ARKIN</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>MERİT</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>LİMAK</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>CONCORDE</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>PASHA</Text></View >
