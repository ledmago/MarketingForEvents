                ...
                <ScrollView
                    ...
                    <View style={styles.tableContent}>
                        ...
                        <View style={{ alignContent: 'center', marginTop:-20, height: 100 + '%', alignItems: 'center', justifyContent: 'center' }}>
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>EZİÇ</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>THE PALM HOUSE</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>EKOR</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>MÜSLÜM BABA</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>THE ROOF</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>NİAZİ'S</Text></View >
