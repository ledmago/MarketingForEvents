            ...
            <View style={styles.container}>
                ...
                <ScrollView
                    ...
                    <View style={styles.tableContent}>
                        ...
                        <View style={{ alignContent: 'center', marginTop:-20, height: 100 + '%', alignItems: 'center', justifyContent: 'center' }}>
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>SALAMİS HOTEL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>ARKIN HOTEL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>MERİT HOTEL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>LİMAK HOTEL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>CONCORDE HOTEL</Text></View >
                            <View style={styles.isletmeler}><Text style={{ fontSize: 25, lineHeight: 40 }}>PASHA HOTEL</Text></View >
